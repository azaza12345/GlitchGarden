...
public class DefenderSpawnerScript : MonoBehaviour
{
    ...
    private Vector2 GetSquareClicked()
    {
        ...
        Vector2 gridPos = SnapToGird(worldPos);
        return gridPos;
    }

    private Vector2 SnapToGird(Vector2 rawWorldPos)
    {
    ...
    {
        defenderScript newDefender = Instantiate(defender, roundedPos, Quaternion.identity) as defenderScript;
